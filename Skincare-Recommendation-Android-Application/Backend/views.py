...
def collaborativeBasedFiltering():
    return jsonify(response=200, message="dummy") 
    #NOTE: Above return is just a dummy success response that we are returning from this
    # collaborativeBasedFiltering API since there's a bug hampering the functionality of
    # even the contentBasedFiltering API.
